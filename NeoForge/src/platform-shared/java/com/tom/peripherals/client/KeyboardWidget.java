...
public class KeyboardWidget extends AbstractWidget {
	...
	@Override
	public void renderWidget(GuiGraphics p_93657_, int p_93658_, int p_93659_, float p_93660_) {
		...
		} else if(state.getBlock() instanceof MonitorBlock) {
	...
	@Override
	public boolean mouseScrolled(double mouseX, double mouseY, double dx, double delta) {
		if (delta != 0.0D) {
			if (monHandler != null)
