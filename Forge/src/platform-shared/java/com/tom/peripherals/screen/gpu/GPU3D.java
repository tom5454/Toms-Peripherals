...
import com.tom.peripherals.screen.gpu.GLConstants.Matrix4d;
import com.tom.peripherals.screen.gpu.GLConstants.TriBuilder;
...
public class GPU3D extends TMLuaObject implements VRAMObject {
	...
	public void glBegin(Object[] a) throws LuaException {
		...
		buildingTri = GLConstants.builder(id, triangles, () -> mat, tm::getTextureID);
	}
